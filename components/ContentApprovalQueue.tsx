...
export default function ContentApprovalQueue({ products }: { products: Product[] }) {
  ...
  return <section className="rounded-lg border border-gray-200 bg-white p-5">
    ...
    <p className="mt-1 text-xs text-gray-500">Prepare peças para Instagram e Facebook. Aprovar não publica conteúdo; publicação futura exige integração oficial da Meta.</p>
