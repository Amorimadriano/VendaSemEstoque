...
const WEEK_DAYS = [
  ...
  { dayOfWeek: 'Quinta-feira', focus: 'Demonstração de Recursos e Uso Prático', channel: 'facebook' as const, contentType: 'REEL' as const, angle: 'Demonstração', scheduledDayIndex: 4 },
